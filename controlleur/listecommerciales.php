                ...
                <div class="col-md-12" style="background:#fff">
                    <div  class="table-responsive">
                        <table class="table" style="font-size:12px; margin-top: 10px;">
                            <input class = "form-control inputiltre mt-2 mb-2 pull-right" style="width:50%"  type = "text" placeholder = "Rechercher">
                            <thead>
                                <tr>
                                    <th>Photo</th>
                                    <th>Matricule</th>
                                    <th style="width:150px!important">Nom</th>
                                    <th>Contact</th>
                                </tr>
                            </thead>
                            <tbody class="tbode">
                                ...
                                <tr>
                                    ...
                                    <td class=""><a href=""><?=$data['matricule']?></a></td>
