...
box-shadow: 3px 2px 5px 0px rgba(0,0,0,0.75);padding:20px 20px">
       ...
       <div class="row" style="padding:10px 0px">
           ...
           <div class="col-md-12">
                <h4 class="text-left py-2" style="font-size:14px;color:#000"><!--tsy azo fafana ny span--><span class="coach"><?=$coach?></span>| <?=$details_coach['Nom']." ".$details_coach['Prenom']?></h4>
            </div>
           <div class="col-md-12">
                    <blockquote>
                            <h4 class="text-left py-2" style="font-size:14px;color:#000">Déduction</h4>
                          <div class="form-row">
                                <div class="form-group col-md-6 col-6 change_observation">
                                  <select class="form-control description_coach">
                                     <option  disabled selected hidden>Déscription</option>
                                ...
                                <div class="form-group col-md-6 col-6">
                                    <input type="date" class="form-control date_deduction_coach" name="date" placeholder="Date">
                                </div>
                                <div class="form-group col-md-6 col-12">
                                    <input type="text" class="form-control montant_deduction_coach" name="montant"  placeholder="Montant (*Ar)">
                                </div>
                               
                                <div class="form-group col-md-6 col-12 obs"><input type="text" class="form-control observation" name="observation"  placeholder="Observation">
                            ...
                            <buttom class="btn btn-success ajoutdeduction_coach pull-right mb-2" style="font-size:12px;color:#fff;cursor:pointer">Enregistrer la Déduction</buttom>
                          <br>
                          <br>
                    </blockquote>
      </div>
      ...
      <div class="col-md-12">
          <br>
                    <blockquote>
                            <h4 class="text-left py-2" style="font-size:14px;color:#000"> Bonus et Prime</h4>
                          <div class="form-row">
                                <div class="form-group col-md-6 col-6"><input type="text" class="form-control motif" name="motif"  placeholder="Motif"></div>
                                <div class="form-group col-md-6 col-6">
                            ...
                            <buttom class="btn btn-success ajoutbonus_coach pull-right" style="font-size:14px;color:#fff;cursor:pointer">Enregistrer Bonus Prime </buttom>
                            <br>
                            <br>
                    </blockquote>
      </div>
