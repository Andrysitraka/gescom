    ...
    <div class="content-header">
        <div class="container-fluid">
          <!-- <div class="row" style="padding-left:7px;padding-right:7px;">
            ...
            <div class="row mb-2">
                <div class="col-md-12">
                     <img src="images/banniere-accueil.jpg" style="height:300px!important" class="bann_accueil">
                </div>
            </div>  
            <div class="row block_menu">
               
                <div class="col-md-6 col-sm-6 col-6  block2">
                    <div class="Planning " style="cursor: pointer;">
                        <div class="text"><i class="fa fa-users"></i><span style="font-size:16px;padding-left:10px"><?= $n2 ;?></span><br>
                            <span style="font-size:16px">  Actifs</span>
                        </div>
                ...
                <div class="col-md-6 col-sm-6 col-6  block4">
                    <div class="penalites">
                        
                        <div class="text"><i class="fa fa-users"></i><span style="font-size:16px;padding-left:10px">20 </span><br>
                        <a href="deductionPrimeCoach.php"/> <span style="font-size:16px;color:#fff"> Mise à jour donnée</span> </a>
                        </div>
                    ...
                    <div  class="table-responsive">
                        <table class="table" style="font-size:12px; margin-top: 10px;">
                            ...
                            <tbody class="tbode">
                                ...
                                ?>
                                <tr>
                                    <td class=""><a href="detailcoach.php?coach=<?=$data['matricule']?>"><img class="img-thumbnail" src="<?=$image?>" width="50px" height="50" ></a></td>
                                    <td class=""><a href="detailcoach.php?coach=<?=$data['matricule']?>"><?=$data['matricule']?></a></td>
