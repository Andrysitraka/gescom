...
<div class="content-wrapper">
   <div class="container">
       ...
       <div class="row" style="padding:10px 0px">
           <div class="col-md-12">
                    <blockquote>
                        <h4 class="text-left py-2" style="font-size:14px;color:#000">Choisissez</h4>
                        <div class="form-row">
                            <div class="form-group col-md-6 col-6">
                                  <select class="form-control choix_deduc_bon">
                                      <option  disabled selected hidden>Objet </option>
           ...
           <div class="col-md-12 deduction_de_coach">
                    <blockquote>
                            <h4 class="text-left py-2" style="font-size:14px;color:#000"><span class="titre">Déduction</span><span class="coach"></span><span class="remarque"> *veuillez choisir un coach</span></h4>
                          <div class="form-row">
                                ...
                                <div class="form-group col-md-6 col-6 obs"><input type="text" class="form-control observation" name="observation"  placeholder="Observation"></div>
                                ...
                                <div class="form-group col-md-4">
                                 ...
                                 <buttom class="btn btn-success ajoutdeduction_coach pull-right" style="font-size:14px;color:#fff;cursor:pointer">Enregistrer Déduction</buttom>
                          </div>
      ...
      <div class="col-md-12 bonus_de_coach d-none">
                    <blockquote>
                            <h4 class="text-left py-2" style="font-size:14px;color:#000"><span class="titre">Prime et bonus</span><span class="coach"></span><span class="remarque"> *veuillez choisir un coach</span></h4>
                          <div class="form-row">
                           ...
                           <buttom class="btn btn-success ajoutbonus_coach" style="font-size:14px;color:#fff;cursor:pointer">Enregistrer bonus et Prime</buttom>
                    </blockquote>
      </div>
   </div>
</div>
