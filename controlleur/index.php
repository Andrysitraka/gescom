...
min-height:00px;">
            <div class="row entete justify-content-center" style="background-color:rgb(255,255,255);">
             ...
             <div class="row entete justify-content-center" style="background-color:rgb(255,255,255);margin-bottom:35px;margin-top:0px">
               <div class="col-md-6 entete_text" style="padding-top:0px;">
                   ...
                   <span style="color:#ffc800;letter-spacing: 0px;font-weight:normal">CONTROLEUR
                  </div>
                   
               </div>
                
            </div>
             <div class="row" style="background: linear-gradient(#f9ca00, #faed00);height:20px;margin-top:60px">
                 <div style="width:150px;height:150px;border-radius:50%;border:5px solid #ffc800;background:#fff;top:-55px;position:relative;margin:auto;overflow:hidden">
                     <img class=""  style="height: 150px;width:150px" src="../image/personnel/OTO108.jpg" alt="">
                 </div>
            ...
            <div class="row" style="background: linear-gradient(#f9ca00, #faed00);height:10px;margin-top:3px">
            ...
            <div class="row" style="background-color:rgb(56,56,56,56);height:20px">
             ...
             <div class="row" style="background-color:rgb(56,56,56);min-height:120px;border-left: 10px solid #ffc800;;border-right: 10px solid #ffc800;">
                 <div class="col-md-12">
                        <h3 class="text-center text-white" style="font-size:20px;font-weight:bold" >RAKOTOARIMALALA</h3>
                        <h5 class="text-center text-white" style="font-weight:bold">Maminirina</h5>
                        <h5 class="text-center text-white" style="font-weight:bold">106 301 033 436</5>
                         <h5 class="text-center text-white" style="font-weight:bold">OTO108</5>
                        
                 </div>
            </div>
            
             <div class="row" style="background-color:rgb(56,56,56);min-height:100px;padding-bottom:20px;border-bottom:solid 10px #ffc800;" >
