...
.tabcontent {
 ...
 <div class="content-wrapper" style="background: white">
    ...
    <div class="content-header">
      ...
      <div class="row">
           <div class="col-md-12" >
             <img src="images/equipe 3.jpg" class="bann_accueil" height="200px">
              <div class="content-header">
                  <div class="container-fluid">
                    <div class="row mb-2 ">
                      <div class="col-sm-6">
            ...
            <table class="table">
              ...
              <tbody>
                ...
                ?>
                    <tr>
                        <?php //var_dump($n); ?>
                      <td class="nom_equipe"><a href="info-produit.php"> 
                       <?= $planingEquipe['IdEquipe'];?> </a></td><!--EQUIPE-009-->
                      <td><?= $lieu['lieu'];?></td>
