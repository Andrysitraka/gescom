          ...
          <div class="col-md-12">
            ...
            <table class="table" style="padding-top:20px">
              ...
              <tbody class="tbode">
                ...
                <tr>
                  <th scope="row"><?=$i?></th>
                  <td class="nom_produit"><?=$produit['idProduit']?></td>
                  <td ><?=$produit['designation']?></td>
                  <td><?=$produit['quantite']?></td>
                  <td>Consulter <i class="fa fa-plus-circle detail_prix" style="color: blue;margin-top: 8px;margin-left:10px;cursor:pointer"></i> <!--<i class="fa fa-plus-circle" data-toggle="modal" data-target="#myModal" style="color: blue;margin-top: 8px;margin-left:10px;cursor:pointer"></i>--></td>
                  <td><?=$category['famille']?></td>
                  <td><?=$category['type']?></td>
                  <td><img src="<?=$image?>" width="50px"></td>
                  <td><a href="information_produit.php?codeProduit=<?=$produit['idProduit']?>"> 
  ...
  <div class="modal-dialog modal-lg" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title w-100" id="myModalLabel">Birdy café Robusta Information Prix</h4>
