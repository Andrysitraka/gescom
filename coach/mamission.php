                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <a href="tel:<?=$pers['Contact']?>"><?=$pers['Contact']?></a></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
            ...
            <div class="col-md-12" style="padding:0px 5px;">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <?php
                                $sql="SELECT `mtrP` FROM `planing_equipe`,equipe,ma_mission,fonction WHERE `statut` LIKE 'Active' AND equipe.idEqupe = ma_mission.id_equipe AND `designationEquipe` LIKE equipe.IdEquipe AND fonction.id = `fonction` AND fonction.DesFonction LIKE ?";
                                $coach = $main->queryAll($sql,array('Coach'));
                                foreach($coach as $coach):
                                    $sql_pers="SELECT `Nom`,`Prenom`,`Contact` FROM `personnel` WHERE `matricule` LIKE ?";
                                    $pers=$main->query($sql_pers,array($coach['mtrP']));
                        ?>
                        <tr>

                             <?php if(file_exists('../image/personnel/'.$coach['mtrP'].'.jpg')){ ?>
                                                <td><a href="../image/personnel/<?=$coach['mtrP'].".jpg"?>"data-lightbox="roadtrip" title=""><?=$coach['mtrP']?> </a></td>
                                            <?php }else{ ?>
                                                <td><a href="../images/point_interro.jpg" data-lightbox="roadtrip" title=""><?=$coach['mtrP']?> </a></td>
                                            <?php } ?>
                            <td><?=$pers['Nom']." ".$pers['Prenom']?></td>
             ...
             <div class="col-md-12" >
                ...
                ?>
                          <ul class="nav nav-pills nav-justified col-md-12" style="padding-right: 0px!important;">
                              <?php 
                                    $i=0;
                           ...
                           <div class="col-md-12 collapse" id="tabcontent1" style="padding:5px 5px;">
                               <table class="table">
                                    <thead style="background:#c51162;padding:0px 0px;color:#fff">
                                        <tr>
                                            <th style="width:20%">Matr</th>
                                            <th style="width:50%">Nom et Prénom</th>
                                            <th style="width:30%">Contact</th>
                           ...
                           <div class="col-md-12 collapse" id="tabcontent2" style=';padding:5px 5px'>
                              <table class="table">
                                <thead style="background:#7b1fa2;padding:0px 0px;color:#fff">
                                    <tr>
                                        <th style="width:20%">Matr</th>
                                        <th style="width:50%">Nom et Prénom</th>
                                        <th style="width:30%">Contact</th>
                           ...
                           <div class="col-md-12">
                    <hr>
                    <h2 style="padding-bottom:10px;font-size:14px">
                         <?php
                            $sql="SELECT `mtrP` FROM `planing_equipe`,fonction,equipe WHERE `fonction` = fonction.id AND fonction.DesFonction LIKE ? AND `statut` LIKE 'Active' AND `designationEquipe` LIKE equipe.IdEquipe AND equipe.idEqupe LIKE ?";
                            $coach_mission=$main->queryAll($sql,array('Coach',$mission['id_equipe']));
                        ?>
