    ...
    <div class="row" style="margin-top:5px">
        <div class="col-md-12" style="background:#fff">
            <table class="table table-hover   table-bordered " style="font-size:13px;margin-top:20px; ">
               <thead>
                   <tr>
                        <td class="" style="width:60%">Total Déduction : </td>
                        <td class="" style="width:40%;font-weight:bold">
                        <?php
            ...
            <table class="table table-hover   table-bordered " style="font-size:13px;margin-top:5px; ">
               <thead>
                   ...
                   <tr>
                        ...
                        <td class="" style="width:60%">Description</td>
                        <td class="" style="width:40%">Montant</td>
                    </tr>
