      ...
      <div class="container-fluid" >
          ...
          <div class="row"  style="padding:0px 10px;margin-top:-10px">
              ...
              <h3 style="font-size:15px;margin-top:10px">Info Point<span class="text-right"> <?php echo ($mission)?$mission['nom_mission']:'(*Pas de Mission)';?>  du  <?=date('d-M-Y')?> </span></h3>
               ...
               <a href="detail-point-jour.php?date=<?=date('d-m-Y')?>" class="btn btn-success btn-xs pull-right"  style="width:60px;height:25px;margin-top:-30px;margin-right:2px">Détails</a>
               
              
            <table class="table table-bordered">
                    <thead>
                      <tr>
                        <th style="font-size:11px;width:40%">Tranche d'heure</th>
                        <th  class="text-right" style="font-size:11px;width:60%">Points</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php 
                      ...
                      <tr>
                       ...
                       <tr>
                        ...
                        <td class="text-right" style="font-size:11px;"><?php
        ...
        <div class="row mt-2" style="padding:0px 10px">
            <div class="col-md-12" style="background:#fff;padding:5px 8px">
                <h3 style="font-size:15px;">Les commerciaux qui n'ont pas de vente enregistré </h3>   
                  ...
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        <th style="font-size:11px;width:40%">VP</th>
                        <th style="font-size:11px;width:30%">Contact</th>
                        <th style="font-size:11px;width:30%">Tuteur</th>
           ...
           <div class="row mt-2" style=";padding:0px 10px">
               <div class="col-md-12" style="background:#fff;padding:5px 8px">
                  ...
                  <table class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <th style="font-size:11px;width:40%">Date</th>
                        <th class="text-center" style="font-size:11px;width:30%">C.A (Ar)</th>
                        <th class="text-center" style="font-size:11px;width:30%">Points</th>
                            ...
                            for($i=1;$i<=$dta;$i++):
                                ...
                                if($testDim=="Sun"){
                                 ...
                                 <tr style="background-color:red;color:#fff;">
                                    ...
                                    <td class="text-right" style="font-size:10px;"><?= $point_jour[$i]." "?></td>
