      ...
      <div class="container-fluid">
          ...
          <div class="row"  style="padding:0px 10px;margin-top:-10px">
            ...
            <table class="table table-bordered">
                    <thead>
                      <tr>
                        <th style="font-size:11px;width:35%">Tranche d'heure</th>
                        <th class="text-center" style="font-size:11px;width:65%">Points</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php 
                      ...
                      <tr>
                        ...
                        <td class="text-right" style="font-size:10px;"><?php
        ...
        <div class="row mt-2" style=";padding:0px 10px">
            <div class="col-md-12" style="background:#fff;padding:px 10px">
                 <h3 class="mt-1" style="font-size:15px;">Les commerciaux qui n'ont pas de vente enregistré </h3>   
                  ...
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        <th style="font-size:11px;width:35%">VP</th>
                        <th style="font-size:11px;width:32.5%">Contact</th>
                        <th style="font-size:11px;width:32.5%">Tuteur</th>
                      </tr>
                    </thead>
                    <tbody>
                        <?php
        ...
        <div class="row mt-2 mb-2" style=";padding:0px 10px">
            <div class="col-md-12" style="background:#fff;">
                <h3 class="mt-1" style="font-size:15px;">Répartition   points  par  commercial</h3>   
                  ...
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        <th style="font-size:11px;width:35%">VP</th>
                        <th style="font-size:11px;width:25%">Contact</th>
                        <th style="font-size:11px;width:20%">C.A (Ar)</th>
                        <th style="font-size:11px;width:20%">Point  coach</th>
                      </tr>
                    </thead>
                    <tbody>
                         <?php
                      ...
                      <tr>
                        ...
                        <td class="text-right" style="font-size:10px;"><?=number_format($main->ca_jour_com($commerciale['matricule'],$date_now),2,',',' ').""?></td>
                        <td class="text-right" style="font-size:10px;"><?=$totalpts;?></td>
                      </tr>
