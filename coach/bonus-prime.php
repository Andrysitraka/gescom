 ...
 <div class="content-wrapper">
    ...
    <div class="row" style="margin-top:5px">
        <div class="col-md-12" style="background:#fff">
             ...
             <tfoot>
                    <tr>
                        <td class="" style="font-size:11px;font-weight:bold;width:50%">Total Bonus et Prime :</td>
                        <td class="text-right" style="font-size:11px;font-weight:bold;width:50%">
                          <b>  <?php 
            ...
            <table class="table table-hover   table-bordered " style="font-size:13px;margin-top:5px; ">
               <thead>
                   ...
                   <tr>
                        ...
                        <td class="" style="font-weight:bold;width:50%">Date/heure</td>
                        <td class="" style="font-weight:bold;width:25%">Motif</td>
                        <td class="" style="font-weight:bold;width:25%">Montant</td>
                    </tr>
               ...
               <tbody>
                    ...
                    ?>
                    <tr>
                        <td class="" style="font-size:11px;"><?=$bonus['date'].' / '.$bonus['heure']?></td>
                        <td class="" style="font-size:11px;"><?=$bonus['motif']?></td>
                        <td class="" style="font-size:11px;"><?=number_format($bonus['montant'],2,',',' ').' Ar'?></td>
