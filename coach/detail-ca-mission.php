    ...
    <div class="content-corp">
      <div class="container-fluid">
          <ol class="breadcrumb" style="font-size:14px!important;padding-left:0px">
              ...
              <li class="active" style="padding:0px 5px" >Détails C.A <?php echo $_GET['matricule'];?></li>
          </ol>
          <div class="row" style="background:#fff;padding:0px 10px">
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td scope="col" width="25%">Total</td>
                          <td scope="col" width="25%"> Produit <?php  $totalqte;?></td>
                          <td scope="col" width="25%"> C.A <?php number_format(@$totalca,2,',',' ')." Ar"?></td>
                          <td scope="col" width="25%">Points <?php $totalpts?></td>
            ...
            <table class="table table-hover text-center  table-bordered" align="center" style="font-size:10px">
                    <thead>
                        ...
                        <tr>
                          <th scope="col" width="25%">Produit</th>
                          <th scope="col" width="25%">Quantite</th>
                          <th scope="col" width="25%">CA</th>
                          <th scope="col" width="25%">Point du coach</th>
