...
<head>
    ...
    <title>MAGESTI</title><link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">
  <?php  
    if($page=="liste_des_clients_sur_terrain"){
      echo '<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.3/Chart.css">';
      echo '<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.3/Chart.bundle.js"></script>';
      echo '<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.3/Chart.js"></script>';
 }?>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-primary navbar-light" style="background: linear-gradient(#ff0000, #bf0d0dc4);">
    <ul class="navbar-nav">
      <li class="nav-item">
...
<div class="container-fluide" style="width:80%;">
   ...
   <ul class="navbar-nav ml-auto">
      <?php if($page!="badge" && $page!="moncompte"): ?>
       <a href="?page="><img style="height:40px;width:40px;margin-top:0px;overflow:hidden;border: solid 3px #fff" src="../image/personnel/<?=$_SESSION['matricule']?>.jpg" alt="User Avatar" class="mr-3 img-circle "></a>
      <?php endif;?>
    </ul>
    ...
    <div class="sidebar">
     ...
     <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview" style="background: #ddd;">
              ...
              <li class="nav-item has-treeview">
                       <a href="?page=mon_planing" class="nav-link">
                      <i class="fa fa-info-circle" aria-hidden="true"></i> Mon planning
                     </a>
                </li>     
...
<div class="content-wrapper">
 ...
 } else if($page=="mon_planing"){
      echo '<script type="text/javascript" src="../js/filterNonPlaning.js"></script>';
 } else if($page=="liste_des_clients_sur_terrain"){
      echo '<script type="text/javascript" src="../js/chartListecclient.js"></script>';
 }
