...
<h4 class="text-center" style="padding-top:5px;padding-bottom:5px;font-size:16px;">PANIER | <a href="#" class="badge badge-success detailPanier" id="<?= $_SESSION['panier']; ?>"><?= $_SESSION['panier']; ?> </a></h4>
  <form class="text-center" style="color: #757575;" action="#!">
            ...
            <div class="form-group">
                <input type="text" style="font-size:10px;opacity:0.7;" class="form-control ville input-ville" required placeholder="Ville">
            </div>


            <div class="form-group">
                <input type="text" style="font-size:10px;opacity:0.7;" class="form-control quartier input-quartier" required placeholder="Quartier">
            </div>
     ...
     <div class="form-row mb-2">
         <div class="col">
                     <div class="md-form">
                        ...
                        <button type="button" data-target="#exist" data-toggle="collapse"  class="btn btn-secondary btn-xs btn-block cli"><i class="fa fa-users" aria-hidden="true"></i>&nbsp;Prospère.</button>
                    </div>
         </div>
