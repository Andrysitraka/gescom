...
<div class="container-fluid" >
        ...
        <div class="col-md-12">
            <ul class="nav nav-pills nav-justified col-md-12">
                <li class="nav-item col-md-6">
                    <a class="nav-link privilege" id="privilege1" style="border-bottom:1px solid; padding: 10px;box-shadow: 5px 10px #888888;">Bi-mestriel</a>
                </li>
                <li class="nav-item col-md-6 ">
    ...
    <div id="tabcontent1" class="collapse" style="background:#fff;">
            <div class="row bg-default" style="z-index:10000;border:1px solid grey;border-radius:5px 5px 5px 5px; box-shadow: 5px 10px #grey;padding:5px">
                            ...
                            <div class="col-md-12" style="padding-bottom:5px;">
                                ...
                                <h3 style="font-size:14px;margin-top: -41px;" class="text-right"> 
                                    <span class="statutBimestriel" style="width:200px;height:55px; padding-left:5px;background:<?=$tabcouleur[$i];?>;color:#fff;border-radius:2px"><?=$statbim;?><br/></span>
                                </h3>
                            </div>
                                 </br>
...
<div id="tabcontent2" class="collapse" style='background:#fff;margin-top:20px;'>
    ...
    <div class="row bg-default" style="z-index:10000;border:1px solid grey;border-radius:5px 5px 5px 5px; box-shadow: 5px 10px #grey;">
                    ...
                    <div class="col-md-12" style="padding:5px;">
                        ...
                        <h3 style="font-size:14px;margin-top: -41px;" class="text-right"> 
                            <span class="statAnnuelle" style="width:200px;height:40px; padding-left:5px;background:<?=$tabcouleurAn[$j];?>;color:#fff;border-radius:2px"><?=$statutAn;?></span>
                            <p></p>
                        </h3>
                    </div>
                         </br>  
